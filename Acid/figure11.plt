...
set mxtics 2
set ylabel "energy (kcal/mol)" font ",15" offset -1.5,0
...
plot  "Aacid/a.dat" u 1:($2) w l lc rgb "red" title "",\
      "Aacid/a.dat" u 1:2 w l lw 4.5 lc rgb "red" title tit[1] at 0.3,0.11,\
     "Aacid/b.dat" u 1:($2) w l lc rgb "blue" title "",\
     "Aacid/b.dat" u 1:2 w l lw 4.5 lc rgb "blue" title tit[2] at 0.3,0.91,\
     "Aacid/a.dat" u 1:5 w l lw 4.5 dt (0.4,2) lc rgb "red" title tit[3] at 0.82,0.11,\
     "Aacid/b.dat" u 1:5 w l lw 4.5 dt (0.4,2) lc rgb "blue" title tit[4] at 0.82,0.91,\
